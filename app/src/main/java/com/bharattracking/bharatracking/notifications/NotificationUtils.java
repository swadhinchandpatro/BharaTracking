...
public class NotificationUtils {
    ...
    public void showNotificationMessage(final String title, final String message, final long timeStamp, Intent intent, String imageUrl) {
        ...
        // notification icon
        final int icon = R.drawable.marker_blue;
        ...
        final NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
                mContext, Utils.ADMIN_CHANNEL_ID);

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(mContext);
        String defaultRingtone = ContentResolver.SCHEME_ANDROID_RESOURCE
                + "://" + mContext.getPackageName() + "/raw/notification";
        String ringtone = preferences.getString(mContext.getString(R.string.key_new_alert_ringtone),defaultRingtone);
        final Uri alarmSound = Uri.parse(ringtone);
    ...
    private void showSmallNotification(NotificationCompat.Builder mBuilder, int icon, String title, String message, long timeStamp, PendingIntent resultPendingIntent, Uri alarmSound) {
        ...
        notification = mBuilder.setSmallIcon(icon).setTicker(title).setWhen(0)
                ...
                .setStyle(inboxStyle)
                .setWhen(timeStamp)
                .setSmallIcon(R.mipmap.bt_logo_small_180)
                .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.bt_logo_large))
    ...
    public void playNotificationSound() {
        try {
            ...
            boolean canVibrate = preferences.getBoolean(mContext.getString(R.string.key_vibrate),false);
            if (canVibrate){
